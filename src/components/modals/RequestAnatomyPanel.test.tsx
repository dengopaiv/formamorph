...
import { allGroupedTabs, isAuthoringTab } from '@/lib/promptGroups';
...
describe('RequestAnatomyPanel preview', () => {
  ...
  it('draws a hub for every prompt in the rail', () => {
    // Turn prompts only: an authoring prompt has no request to lay out, so it opens its System template
    // instead of a hub (see SettingsModal).
